...
<script>
  gtag('event', 'conversion', {'send_to': 'AW-11457128767/4ACFCMGzlMUZEL_Sl9cq'});
</script>
    
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-11457128767"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-11457128767');
</script>
</head>
...
<!-- START HEADER -->
<header class="header_wrap" style="background-color:#FFBC09">
    {{-- <header class="header_wrap bg_blue_dark light_skin"> --}}
        <div class="top-header light_skin" style="background-color: #5B7842">
        <div class="container">
                ...
                <div class="col-md-6">
                	<div class="d-flex flex-wrap align-items-center justify-content-md-end justify-content-center mt-2 mt-md-0">
                        ...
                        <ul class="list_none header_list border_list ml-1">
                            ...
                            @else
                            <li><a href="https://app.abhigyaanacademy.com"  data-toggle="modal" data-target="#Login" class="btn btn-default btn-sm rounded-0" style="font-size: 1.3rem">Login/Signup</a></li>
        ...
        <nav class="navbar navbar-expand-lg"> 
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent" ">
                <ul class="navbar-nav" style="display: flex; justify-content: center; width: 100%;">
                    <li class="dropdown">
                        <a class="nav-link @if (request()->is('home') || request()->is('/')) active @endif" href="/" style="color: rgb(68, 66, 66);font-size: 1.2rem;"2rem>Home</a>
                       
                    </li>
                    <li class="dropdown">
                        <a class="nav-link  @if (request()->is('courses')) active @endif" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: rgb(68, 66, 66); font-size: 1.2rem;">Popular Exams</a>
                        <div class="dropdown-menu">
                            <ul> 
                                <li><a class="nav-link  @if (request()->is('nda_course')) active @endif" href="/nda_course" style="color:  rgb(206, 235, 19);font-size: 1.2rem;">NDA</a></li> 
                                <li><a class="nav-link  @if (request()->is('cds_course')) active @endif" href="/cds_course" style="color: rgb(206, 235, 19);font-size: 1.2rem;">CDS</a></li>
                                <li><a class="nav-link  @if (request()->is('afcat_course')) active @endif" href="/afcat_course" style="color: rgb(206, 235, 19);font-size: 1.2rem;">AFCAT</a></li>
                                <li><a class="nav-link  @if (request()->is('capf_course')) active @endif" href="/capf_course" style="color: rgb(206, 235, 19);font-size: 1.2rem;">CAPF (Asst Commandant)</a></li>
                                <li><a class="nav-link  @if (request()->is('ssb_course')) active @endif" href="/ssb_course" style="color: rgb(206, 235, 19);font-size: 1.2rem;">SSB Interview</a></li>
                                <li><a class="nav-link  @if (request()->is('coast_guard_course')) active @endif" href="/coast_guard_course" style="color: rgb(206, 235, 19);font-size: 1.2rem;">Coast Guard</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link  @if (request()->is('courses')) active @endif" href="/courses" style="color: rgb(68, 66, 66);font-size: 1.2rem;">Course</a>
                        {{-- <div class="dropdown-menu">
                            <ul> 
                    ...
                    <li class="dropdown">
                        <a class="nav-link @if (request()->is('blogs')) active @endif" href="/blogs" style="color: rgb(68, 66, 66);font-size: 1.2rem;">Blogs</a>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link @if (request()->is('free_resources')) active @endif" href="/free_resources" style="color: rgb(68, 66, 66);font-size: 1.2rem;">Free Resources</a>
                    </li>
                    <li>
                        <a class="nav-link @if (request()->is('contact')) active @endif" href="/contact" style="color: rgb(68, 66, 66);font-size: 1.2rem;">Contact</a>
                    </li>
                </ul>
            </div>
