...
<meta content="
{{ isset($title) ? $title : 'Abhigyan Academy | Best Defence Coaching Institute in Guwahati' }}
" name="author">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="    
{{ isset($meta_description) ? $meta_description : 'Abhigyan Academy, Guwahati\'s top defense coaching institute, offers expert training for NDA, CDS, AFCAT, and more. Achieve your defense career dreams with us.'}}">

<meta name="keywords" content="
{{ isset($meta_keywords) ? $meta_keywords : 'indian army, cds, navy, afcat, academy, course, education, elearning, learning, education html , university , college , school , online education , tution center'}}">
...
<meta name="author" content="complit.in">
<meta property="og:title" content="
{{ isset($title) ? $title : 'Abhigyan Academy | Best Defence Coaching Institute in Guwahati' }}
">
<meta property="og:description" content="
{{ isset($meta_description) ? $meta_description : 'Abhigyan Academy, Guwahati\'s top defense coaching institute, offers expert training for NDA, CDS, AFCAT, and more. Achieve your defense career dreams with us.'}}">
<meta property="og:image" content="https://abhigyanacademy.com/assets/images/abhigyan_academy_logo_small.webp">
<meta property="og:url" content="https://abhigyanacademy.com">
...
<script>
    ...
    <style>
        ...
        a:hover, .btn-outline-white:hover, .top-header.light_skin .header_list li a:hover, .top-header.light_skin .contact_detail li a:hover, .social_white .social_icons li a:hover, .social_white.social_icons li a:hover, .navbar-expand-lg .navbar-nav > li > a.active, .navbar-expand-lg .navbar-nav > li:hover > a, .dark_skin .navbar-expand-lg .navbar-nav .dropdown-menu li a.active, .dark_skin .navbar-expand-lg .navbar-nav .dropdown-menu li a:hover, .dark_skin .navbar-expand-lg .navbar-nav .dropdown-menu > ul > li:hover > a, .dark_skin .navbar-expand-lg .navbar-nav .dropdown-menu > ul > .mega-menu-col ul > li:hover > a, .navbar-expand-lg .navbar-nav .dropdown-menu li a.active, .navbar-expand-lg .navbar-nav .dropdown-menu li a:hover, .navbar-expand-lg .navbar-nav .dropdown-menu > ul > li:hover > a, .navbar-expand-lg .navbar-nav .dropdown-menu > ul > .mega-menu-col ul > li:hover > a, .ripple, .content_meta li a:hover, .blog_meta li a:hover, .blog_meta li i, .footer_dark .widget_links li a:hover, .footer_dark .footer_link li a:hover, .footer_dark .post_content h6 a:hover, .footer_dark .contact_info a:hover, .nav-tabs .nav-link.active, .nav-tabs .nav-link.active:hover, .search_form button:hover, .owl-theme .owl-nav [class*="owl-"]:hover, .program_info li{
...
<body>
    ...
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-NY9MGM1TPP"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-NY9MGM1TPP');
</script>
                	...
                	<div class="col-lg-7">	
                    	<div class="padding_eight_all">
                    		<ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="login-tab1" data-toggle="tab" href="#login" role="tab" aria-controls="login" aria-selected="true">Login/Signup</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="login" role="tabpanel">
                                    ...
                                    <form method="post" action="/student-login" class="login form_style2">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-default btn-block rounded-0" name="login">Login/Signup</button>
                                        </div>
                                    </form>
                ...
                <div class="col-md-6">
                	<div class="d-flex flex-wrap align-items-center justify-content-md-end justify-content-center mt-2 mt-md-0">
                        ...
                        <ul class="list_none header_list border_list ml-1">
                            ...
                            @else
                            <li><a href="https://app.abhigyaanacademy.com"  data-toggle="modal" data-target="#Login" class="btn btn-default btn-sm rounded-0">Login/Signup</a></li>
        ...
        <nav class="navbar navbar-expand-lg"> 
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">Popular Exams</a>
                        <div class="dropdown-menu">
                            <ul class="bg_army2"> 
                                <li><a class="nav-link  @if (request()->is('nda_course')) active @endif" href="/nda_course">NDA</a></li> 
                                <li><a class="nav-link  @if (request()->is('cds_course')) active @endif" href="/cds_course">CDS</a></li>
                                <li><a class="nav-link  @if (request()->is('afcat_course')) active @endif" href="/afcat_course">AFCAT</a></li>
                                <li><a class="nav-link  @if (request()->is('capf_course')) active @endif" href="/capf_course">CAPF (Asst Commandant)</a></li>
                                <li><a class="nav-link  @if (request()->is('ssb_course')) active @endif" href="/ssb_course">SSB Interview</a></li>
                                <li><a class="nav-link  @if (request()->is('coast_guard_course')) active @endif" href="/coast_guard_course">Coast Guard</a></li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link @if (request()->is('free_resources')) active @endif" href="/free_resources">Free Resources</a>
                    </li>
...
<!-- END HEADER --> 
@yield('content')
@if(!isset($allSections) || $allSections->where('id', 11)->first()?->is_active == 1)

<!-- START FOOTER -->
<footer class="bg_army2 footer_dark">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-sm-8 mb-4 mb-lg-0">
                    ...
                    <div class="mapouter" style="position:relative;text-align:right;height:250px;width:100%;">
                        <iframe 
                            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1790.180538337458!2d91.758862!3d26.18493!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x375a594891aaa181%3A0xd639577f03e9c0d8!2sNDA%20CDS%20CAPF%20(AC)%20%26%20CUET%20(UG)%20%2F%20(PG)%20Coaching%20Institute%20(Abhigyan%20Academy)!5e0!3m2!1sen!2sin!4v1747472606421!5m2!1sen!2sin" 
                            width="100%" 
                            height="250" 
                            style="border:0;" 
                            allowfullscreen="" 
                    ...
                    <ul class="contact_info contact_info_light list_none mt-5">
                        <li>
    ...
    <div class="bottom_footer bg_army2">
    	<div class="container">
        	<div class="row align-items-center">
            	<div class="col-md-6">
                	<p class="copyright m-md-0 text-center text-md-left">© {{date('Y')}} All Rights Reserved by CHIPS CARE. Powered by <a style="color:orange" href="https://complit.in">COMPLIT</a></p>
                </div>
                <div class="col-md-6">
...
<div class="whatsapp-icon" onclick="openWhatsApp()">
    <img src="/assets/images/all_new/whatsapp.svg" alt="WhatsApp">
</div>

<script>
    function openWhatsApp() {
        var phoneNumber = '+919540504779'; // Replace with your WhatsApp number
        var message = 'Hello, I would like to know more about your services.'; // Default message
