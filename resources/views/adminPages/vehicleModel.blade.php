                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="categoryId" name="categoryId" style="width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        @for ($i = 0; $i < count($allSubcategories); $i++)
                                            <tr>
                                                ...
                                                <td>{{$allSubcategories[$i]['brandName'] }}</td>
...
<a href="{{ url($allSubcategories[$i]['image']) }}" target="_blank" >Preview</a>
    ...
    @if ($selectSubCatId != null)
        <script>
            ...
            $('#brandId').val({{ $selectSubCatId->brandId }}).tigger('change');
        </script>
    @endif
