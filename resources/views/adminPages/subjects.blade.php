                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                            @if ($selectSubCatId == null)
                            <form role="form" action="/subjects" method="post" enctype="multipart/form-data">
                                @else
                                    <form role="form" action="/edit-subject" method="post"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="exampleInputEmail1">Subject Name <span
                                    ...
                                    <div class="form-group">
                                        <label for="customFile">Select Subject Image</label>
                                ...
                                <table id="table21" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @for ($i = 0; $i < count($allSubjects); $i++)
                                            <tr>
                                                <td>{{ $allSubjects[$i]['id'] }}</td>
                                                <td>{{ $allSubjects[$i]['name'] }}</td>
                                                <td> <!-- HTML code to open image in modal -->
<a href="{{ url($allSubjects[$i]['icon_url']) }}" target="_blank" >Preview</a>
</td>
                                                <td>
                                                <a href="/edit-subject/{{ $allSubjects[$i]['id'] }}"
                                                        class="btn btn-primary btn-sm">Edit</a>
                                                    <a href="/delete-subject/{{ $allSubjects[$i]['id'] }}"
    ...
    @if ($selectSubCatId != null)
        <script>
            $('#SubjectId').val({{ $selectSubCatId->SubjectId }});
        </script>
    @endif
@endsection
