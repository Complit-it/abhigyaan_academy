                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                            @if ($selectSubCatId == null)
                            <form role="form" action="/topics" method="post" enctype="multipart/form-data">
                                @else
                                    <form role="form" action="/edit-topic" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="subject_id">Select Subjects <span style="color:red">*</span></label>
                                            <select class="form-control select2" id="subject_id" name="subject_id" style="width: 100%;" onchange="getSubCategory(this);">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="exampleInputEmail1">Topics Name <span
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="customFile">Select Topics Image</label>
                                ...
                                <table id="table21" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @for ($i = 0; $i < count($allTopics); $i++)
                                            <tr>
                                                <td>{{ $allTopics[$i]['id'] }}</td>
                                                <td>{{ $allTopics[$i]['subject_name'] }}</td>
                                                <td>{{ $allTopics[$i]['name'] }}</td>
                                                <td> <!-- HTML code to open image in modal -->
<a href="{{ url($allTopics[$i]['icon_url']) }}" target="_blank" >Preview</a>
</td>
                                                <td>
                                                <a href="/edit-topic/{{ $allTopics[$i]['id'] }}"
                                                        class="btn btn-primary btn-sm">Edit</a>
                                                    <a href="/delete-topic/{{ $allTopics[$i]['id'] }}"
