...
<script>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4" id="descriptionDiv">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  placeholder="" name="description" id="description" class="form-control col-md-12"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#scheduledToDiv').hide();
            $('#descriptionDiv').hide();
            getFields(document.getElementById('category'));
            if($('#category').val() != 6){
                $('#statusDiv').hide();
                $('#titleDiv').hide();
        ...
        function getFields(category) {
            ...
            // Category 2 is for Popular Exams
                ...
                $('#imageTo').show();
                $('#titleDiv').show();
                $('#descriptionLabel').text('Blog Slug');
