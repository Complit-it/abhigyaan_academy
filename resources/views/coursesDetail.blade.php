        	...
        	<div class="col-lg-9">
            	<div class="single_course">
                    <div class="course_img">
                        <a href="#">
                            <img src="/{{ $package->package_image }}" alt="{{$package->package_name}}">
                        </a>
                        <div class="price">
                        	<span class="alert alert-success"><strong>Price :</strong> Rs.{{$package->package_price}}</span>
                        </div>
                    ...
                    <div class="course_tabs">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab1">
                               <div class="border radius_all_5 tab_box"> <p>{{$package->package_description}}</p></div>
                            </div>
