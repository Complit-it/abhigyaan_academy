    ...
    <div id="carouselExampleControls" class="banner_content_wrap carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            ...
            @foreach($bannersList as $key => $banner)
                <div class="carousel-item{{ $key === 0 ? ' active' : '' }} background_bg overlay_bg_50" data-img-src="{{ $banner->imageUrl }}">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-9 col-sm-12 text-center">
                                    <div class="banner_content animation text_white" data-animation="fadeIn" data-animation-delay="0.8s">
                                        <h2 class="font-weight-bold animation text-uppercase" data-animation="zoomIn" data-animation-delay="1s">Abhigyaan<span class="text_default"> Academy</span></h2>
                                        <p class="animation" data-animation="zoomIn" data-animation-delay="1.5s">THINK DEFENCE, THINK ABHIGYAN.</p>
                                        <a class="btn btn-default animation rounded-0" href="#" data-animation="zoomIn" data-animation-delay="1.8s">Explore Courses</a>
                                    </div>
                                </div>
                            </div>
                        </div><!-- END CONTAINER--> --}}
	...
	<div class="container-fluid p-0">
    	<div class="row no-gutters ">
        	<div class="col-lg-6">
                <div class="bg_gray h-100 d-flex align-items-center padding_eight_all">
                	<div class="animation" data-animation="fadeInLeft" data-animation-delay="0.02s">
                        ...
                        <p>{!! \Illuminate\Support\Str::limit($about->description, 860) !!}</p>
            ...
            <div class="col-lg-6 animation" data-animation="fadeInRight" data-animation-delay="0.03s">
            	<div class="overlay_bg_30 about_img z_index_minus1 h-100 background_bg md-height-300" data-img-src="{{$about->imageUrl}}"></div>
...
<!-- START SECTION VIDEO -->
<section class="parallax_bg overlay_bg_70" data-parallax-bg-image="/assets/images/all_new/video_bg.jpg">
	<div class="container">
    	<div class="row justify-content-center">
        	<div class="col-md-6">
            	<div class="text-center animation" data-animation="fadeInUp" data-animation-delay="0.01s">
        	...
        	<div class="col-lg-4 col-sm-6">
            	<div class="content_box radius_all_10 box_shadow1 animation" data-animation="fadeInUp" data-animation-delay="0.01s">
                    ...
                    <div class="content_desc">
                        ...
                        <p>{!! \Illuminate\Support\Str::limit($package->package_description, 20) !!}</p>
        	...
        	<div class="col-lg-4 col-md-6">
            	<div class="blog_post box_shadow1 animation" data-animation="fadeInUp" data-animation-delay="0.02s">
                    ...
                    <div class="blog_content bg-white">
                        ...
                        <p>{{ Illuminate\Support\Str::limit($blog->actual_blog, 100) }}</p>
