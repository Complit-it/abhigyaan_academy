...
//     Route::get('/revive-vendor/{id}', 'App\Http\Controllers\Admin\ProfileControler@reviveVendor')->name('revive-vendor');
    ...
    //pdfs
    Route::get('/pdf-text', 'App\Http\Controllers\ResourcesData@pdftexts')->name('pdf-text');
    Route::post('/pdf-text', 'App\Http\Controllers\ResourcesData@addPdftext')->name('pdf-text');
    Route::get('/edit-pdf-text/{id}', 'App\Http\Controllers\ResourcesData@editPdftext')->name('pdf-text');
    Route::post('/edit-pdf-text', 'App\Http\Controllers\ResourcesData@updatePdftext')->name('pdf-text');
    Route::get('/delete-pdf-text/{id}', 'App\Http\Controllers\ResourcesData@deletePdftext')->name('delete-pdf-text');
    ...
    //view Batch Students
    Route::get('/view-batch-students/{batchId}', 'App\Http\Controllers\ResourcesData@viewStudentsinBatch');
