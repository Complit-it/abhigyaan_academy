                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Add Problem Category to Problem Mapping</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                ...
                                <h3 class="card-title">
                                    @if ($selectSubCatId != null)
                                        Update Problem Category to Problem Mapping
                                    @else
                                        Add Problem Category to Problem Mapping
                                    @endif
                                </h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            @if ($selectSubCatId == null)
                            <form role="form" action="/problem-category-to-problems" method="post" enctype="multipart/form-data">
                                @else
                                    <form role="form" action="/edit-problem-category-to-problems" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="brandId">Select problem category <span style="color:red">*</span></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="categoryId">Select Problem <span style="color:red">*</span></label>
                                            <select class="form-control select2" id="categoryId" name="categoryId[]" multiple style="width: 100%;">
                                                ...
                                                @foreach ($allcategories as $category)
                                                    <option value="{{ $category->id }}" {{ $category->id == $editId ? 'selected' : '' }}>
                                                      {{ $category->providerType}} - {{ $category->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Problem Category to Problem Mapping List</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($allMappings as $subCategory)
                                            <tr>
                                                ...
                                                <td>{{ $subCategory->pc }}</td>
                                                <td>{{ $subCategory->providerType }}</td>
                                                <td>{{ $subCategory->service }}</td>
                                                <td>
                                                    {{-- <a href="/problem-category-to-problems/{{ $subCategory->id }}/edit" class="btn btn-primary">Edit</a> --}}
                                                    <a href="/problem-category-to-problems/{{ $subCategory->id }}/delete" class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
