                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                            @if ($selectSubCatId == null)
                                <form role="form" action="addSubCategory" method="post" enctype="multipart/form-data">
                                @else
                                    <form role="form" action="editSubCategoryPost" method="post"
