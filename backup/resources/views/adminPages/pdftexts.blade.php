                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                            @if ($selectSubCatId == null)
                            <form role="form" action="/pdf" method="post" enctype="multipart/form-data">
                            @else
                                    <form role="form" action="/edit-pdf" method="post"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="PDF Title"
                                            @if ($selectSubCatId != null) value="{{ $selectSubCatId->title }}" @endif
                                            name="title" required>
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="extractedText">PDF Extracted Text</label>
                                        <textarea class="form-control" name="extracted_text" id="extractedText" rows="10" placeholder="Enter or paste extracted text here..."></textarea>
                                    </div>
                            ...
                            <div class="card-body">
                                <table id="table21" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @for ($i = 0; $i < count($allpdfs); $i++)
                                            <tr>
                                                <td>{{ $allpdfs[$i]['id'] }}</td>
                                                <td>{{ $allpdfs[$i]['subject_name'] }}</td>
                                                <td>{{ $allpdfs[$i]['topic_name'] }}</td>
                                                <td>{{ $allpdfs[$i]['sub_topic_name'] }}</td>
                                                <td>{{ $allpdfs[$i]['sub_sub_topic_name'] }}</td>
                                                <td>{{ $allpdfs[$i]['title'] }}</td>
                                                <td> <!-- HTML code to open image in modal -->
                                                    <a href="{{ $allpdfs[$i]['file_url'] }}" target="_blank" >Preview</a>
                                                </td>
                                                <td>
                                                <a href="/edit-pdf/{{ $allpdfs[$i]['id'] }}"
                                                        class="btn btn-primary btn-sm">Edit</a>
                                                    <a href="/delete-pdf/{{ $allpdfs[$i]['id'] }}"
